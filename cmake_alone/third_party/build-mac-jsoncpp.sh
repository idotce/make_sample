...
pack_url=https://github.com/open-source-parsers/jsoncpp/archive/1.9.6.tar.gz
pack_file=$pwd_dir/_download/jsoncpp-1.9.6.tar.gz
proj_dir=$pwd_dir/_download/jsoncpp-1.9.6
build_dir=$pwd_dir/_download/jsoncpp-1.9.6/_build
build_out=$pwd_dir/macos/jsoncpp/
if [ ! -d "$base_dir" ]; then
