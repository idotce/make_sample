...
pack_url=https://mirror.accum.se/mirror/gnu.org/savannah/freetype/freetype-2.14.1.tar.xz
pack_file=$pwd_dir/_download/freetype-2.14.1.tar.xz
proj_dir=$pwd_dir/_download/freetype-2.14.1
build_dir=$pwd_dir/_download/freetype-2.14.1/_build
build_out=$pwd_dir/macos/freetype/
if [ ! -d "$base_dir" ]; then
