...
pack_url=https://www.ohse.de/uwe/releases/lrzsz-0.12.20.tar.gz
pack_file=$pwd_dir/_download/lrzsz-0.12.20.tar.gz
proj_dir=$pwd_dir/_download/lrzsz-0.12.20
build_dir=$pwd_dir/_download/lrzsz-0.12.20/_build
