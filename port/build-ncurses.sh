...
pack_url=https://mirrors.ustc.edu.cn/gnu/ncurses/ncurses-6.4.tar.gz
pack_file=$pwd_dir/_download/ncurses-6.4.tar.gz
proj_dir=$pwd_dir/_download/ncurses-6.4
build_dir=$pwd_dir/_download/ncurses-6.4/_build
