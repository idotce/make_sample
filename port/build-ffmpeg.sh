...
export LDFLAGS="-static -L${TOOLCHAIN}/aarch64-linux-gnu/lib -L${pwd_dir}/_install/userdata/lib -lpthread"

# 工程代码
base_dir=$pwd_dir/_download
pack_url=https://ffmpeg.org/releases/ffmpeg-4.2.tar.gz
pack_file=$pwd_dir/_download/ffmpeg-4.2.tar.gz
proj_dir=$pwd_dir/_download/ffmpeg-4.2
build_dir=$pwd_dir/_download/ffmpeg-4.2/_build
