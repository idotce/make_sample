...
set OPENSSL_DIR=%NDK_DIR%/toolchains/llvm/prebuilt/windows-x86_64/sysroot/usr
set CMAKE_OPT= ^
 ...
 -D OPENSSL_CRYPTO_LIBRARY=%OPENSSL_DIR%/lib/arm64-v8a/libcrypto.a ^
 -D OPENSSL_SSL_LIBRARY=%OPENSSL_DIR%/lib/arm64-v8a/libssl.a ^
